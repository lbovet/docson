...
function init() {
    _jquery2.default.get(docson.templateBaseUrl + "/box.html").done(function (content) {
        source = content;
        boxTemplate = Handlebars.compile(source);

        _jquery2.default.get(docson.templateBaseUrl + "/signature.html").done(function (content) {
            source = content;
